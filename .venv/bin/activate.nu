...
export-env {
    ...
    let virtual_env = r#'/home/appeyron/Documents/MSIT/Phase 1 - Core Learning/Term 5 - 080626-050726/Week 4 - 290626-050726/Codio/Movie Project Flask + SQLAlchemy/.venv'#
    let bin = r#'bin'#
